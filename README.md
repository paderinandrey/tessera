...
| Size | Deterministic p95 | With NER, p95 |
|---|---|---|
| sentence (80 chars) | 0.1 ms | 115 ms |
| paragraph (1 200 chars, one chunk) | 0.6 ms | 969 ms |
| document (6 000 chars, several chunks) | 3.3 ms | 5 566 ms |
...
> would have reported 115 ms and hidden that, which is why the harness uses a size ladder.
>
